...
status: SHIPPED · slice: lifecycle-phase2-completion · base: 24fc095 · branch: feat/lifecycle-phase2-completion · created: 2026-09-23 · updated: 2026-09-24
...
15. [x] Ship: commit, push, PR, reviewer agent, merge — PR #30 (8 commits + PR-review fixes) reviewed by 4 independent area reviewers (25 findings, 24 fixed), CI green, merged 812843c; PR #31 (canonical receipts for Flashblocks) reviewed and merged 6be5ad7.
16. [x] Ops: deploy-contracts (verify → v2), repo vars, IAM, deploy-gcp, oracle job, audit (procedure: `docs/runbooks/operations.md`) — two v2 broadcasts failed on Base Flashblocks pre-confirmation receipts (orphan AMMs 0x615e…F500, 0x07Bb…2Fb8, no wiring); after #31 run 35960788761 deployed MarketAMM v2 0xc2cA0Ac545f87b0301B71fFd5BBCa82e1019CC77 and MarketFactory v2 0x93967Bc3bed8705988109Ee52c7E076a43724a6E (deployBlock 47230282, 1 legacy market imported); repo vars set; IAM already sufficient; OU_QUESTION_ID_KEY created; deploy-gcp run 35961599099 green; oracle job listed 16/16 week-3 games (2 via replay after intermittent stale-read 500s, fixed in the follow-up).
...
- 2026-09-24 SHIPPED — merged #30 and #31, v2 contracts live on 84532, app deployed, week 3 listed. Follow-ups: Flashblocks stale-read hardening in backend/oracles, mobile 84532 asset, Cursor spend limit (user), CDP Portal allowlist (user).

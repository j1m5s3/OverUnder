      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
        <div>
          ...
          <div style={{ fontSize: 14 }}>
            {hasOpened ? "Market is open" : "Not yet opened"}
          </div>
        </div>
        ...
        <div>
          ...
          <div style={{ fontSize: 14 }}>
            After consensus oracle resolves
          </div>
        </div>
        
        <div style={{ borderTop: "1px solid var(--border)", paddingTop: 12, marginTop: 4 }}>
          <div className="muted" style={{ fontSize: 12, lineHeight: 1.5 }}>
            Binary YES/NO market. Winning outcome tokens redeem 1:1 for USDC. 
            1% AMM fee on all trades. Three AI oracles must agree to resolve; 
            otherwise 24h majority vote plus participant votes.
          </div>
        </div>
      </div>
    </div>

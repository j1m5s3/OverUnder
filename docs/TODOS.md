...
todos:
  ...
  - id: OU-T004
    ...
    pointers:
      ...
      - "[backend/app/emissions/router.py : L162-350]"
  - id: OU-T005
    ...
    pointers:
      ...
      - "[oracles/agents/cursor_runtime.py : L312-332]"
  ...
  - id: OU-T006
    ...
    pointers:
      ...
      - "[mobile/lib/features/trade/amm_swap_widget.dart : L81-110]"
  - id: OU-T007
    ...
    pointers:
      ...
      - "[backend/app/models.py : L144-162]"
  - id: OU-T008
    ...
    pointers:
      - "[contracts/src/lib/NormalMath.vy : L1-8]"
      - "[contracts/src/lib/NormalMath.vy : L140-160]"
      - "[contracts/src/lib/NormalMath.vy : L179-229]"
      - "[contracts/tests/test_normal_math.py : L106-128]"
  - id: OU-T009
    ...
    pointers:
      ...
      - "[contracts/tests/test_amm_pm.py : L621-662]"
  - id: OU-T010
    ...
    pointers:
      ...
      - "[contracts/tests/test_factory_listing.py : L207-256]"
  - id: OU-T011
  ...
  - id: OU-T013
    ...
    pointers:
      ...
      - "[oracles/listing/run.py : L139-294]"
      - "[backend/app/markets/router.py : L177-240]"
      - "[oracles/job.py : L60-101]"
  - id: OU-T014
    ...
    pointers:
      ...
      - "[oracles/resolve/general.py : L322-325]"

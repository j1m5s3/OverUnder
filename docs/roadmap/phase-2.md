...
status: MIXED
area: roadmap
summary: MIXED spec — Flutter/emissions/KYC/Cursor-runtime agents shipped; remaining paymaster, JWKS, leftover CLOB relayer, uniform-LVR, permissionless listing.
...
This file is MIXED. [SHIPPED] Flutter (OU-T006), emissions (OU-T004), Cursor-runtime agents (OU-T005), score scout (OU-T011), MoonPay/KYC (OU-T007). Remaining open: paymaster (OU-T001), Privy JWKS (OU-T002), leftover CLOB production relayer (OU-T003), uniform-LVR (OU-T008/T009), permissionless listing (OU-T010). CLOB UX is an optional overlay, not a required depth-chart milestone. Do not invent ERC-4337, JWKS, or uniform-LVR as shipped.
